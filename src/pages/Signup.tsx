...
const Signup = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      {/* Main content */}
      <main className="flex-1 w-full max-w-xl mx-auto px-auto sm:px-auto lg:px-auto py-auto"> {/* Adjusted max width */}
        <div className="glass p-8 rounded-lg shadow-md border border-white/20 backdrop-blur-lg bg-white/10"> {/* Increased padding */}
          <div className="flex justify-center mb-4">
            <div className="p-3 bg-medical-50 rounded-full shadow-md animate-pulse-once">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-center">Full Name</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-center">User  ID</FormLabel>
                      <FormControl>
                        <div className="relative">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-center">Contact Number</FormLabel>
                      <FormControl>
                        <div className="relative">
  ...
  render={({ field }) => (
    <FormItem>
        ...
        <FormLabel className="text-center">Position/Post</FormLabel>
        <FormControl>
          <div className="relative">
...
/>
              ...
              <div className="flex justify-center mt-6"> {/* Centering the button */}
                <Button 
                  type="submit" 
                  className="w-28 h-12 text-base font-medium button-hover-effect bg-white/2 hover:bg-gray-300 border-2 border-gray-400 rounded-3xl"
                  disabled={isLoading}
                >
                  {isLoading ? (
